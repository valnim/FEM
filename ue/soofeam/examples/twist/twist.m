function [mymodel,analysis] = twist
...
element_type = nsModel.nsType.Type(1, 'hex', 2);
...
% Constructor of nsModel.nsType.Type: self = Type(shape_order, shape_type, number_of_int_points)
face_type = nsModel.nsType.Type(1, 'quad', 2);
mymodel.setBoundaryType(face_type);
mymodel.boundary_type.setImplementation(nsAnalyzer.nsImplementation.NonlinearBoundaryImpl());
