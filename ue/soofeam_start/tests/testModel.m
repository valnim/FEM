...
fprintf('Coordinates of node number 89:\n')
disp(model.node_dict(89).undeformed_coordinates)

fprintf('Node numbers of nodes at element number 23:\n')
disp([model.element_dict(23).node_list.number])

fprintf('Coordinates of these nodes:\n')
disp(model.element_dict(23).getCoordinateArray('undeformed'))

fprintf('Information about boundary 3:\n')
disp(model.boundary_dict(3).face_list)
